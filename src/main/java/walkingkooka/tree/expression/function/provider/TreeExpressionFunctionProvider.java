        ...
        this.infos = ExpressionFunctionInfoSet.empty(CaseSensitivity.SENSITIVE)
            .setElements(
                Sets.of(
                    ...
                    nameToExpressionFunctionInfo(ExpressionFunctions.log()),
                    nameToExpressionFunctionInfo(ExpressionFunctions.loggingLevel()),
                    ...
                    nameToExpressionFunctionInfo(ExpressionFunctions.warn())
                )
            );
    }
