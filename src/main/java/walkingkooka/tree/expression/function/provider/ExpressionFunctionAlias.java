...
public final class ExpressionFunctionAlias implements PluginAliasLike<ExpressionFunctionName, ExpressionFunctionSelector, ExpressionFunctionAlias> {
    ...
    private ExpressionFunctionAlias(final PluginAlias<ExpressionFunctionName, ExpressionFunctionSelector> pluginAlias) {
    ...
    @Override
    public int compareTo(final ExpressionFunctionAlias other) {
    ...
    public boolean equals(Object other) {
        return this == other || other instanceof ExpressionFunctionAlias && this.equals0(Cast.to(other));
    }

    private boolean equals0(final ExpressionFunctionAlias other) {
    ...
    private final PluginAlias<ExpressionFunctionName, ExpressionFunctionSelector> pluginAlias;
}
